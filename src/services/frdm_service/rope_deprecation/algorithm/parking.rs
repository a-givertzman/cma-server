...
///
/// [Parking] |
/// Расчитывает блоки, прямолинейные участки и дуги в парковочном положении,
/// это необходимо для точного расчета длины крюковой подвески
/// 
/// Запускается однажды в самом начале для расчета
/// - Угла схода каната с лебедки в парковочном положении
/// - Длинны каната на лебедке в парковочном положении
pub struct Parking {
...
impl Parking {
    ///
    /// Returns [Parking] new instance
    pub fn new(parent: impl Into<String>, rope_sections: RopeSections) -> Self {
        Self {
            rope_sections,
            dbg: Dbg::new(parent, "Parking"),
        }
    }
    ///
    /// Evaluates `Parking` position
