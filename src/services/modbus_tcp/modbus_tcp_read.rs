...
///
/// Reads registers from the `Device` and sends to the`Client`
pub struct ModbusTcpRead {
    name: Name,
    conf: ModbusTcpConf,
...
impl ModbusTcpRead {
    //
    /// Crteates new instance of the [ModbusTcpRead] 
...
//
// 
impl std::fmt::Debug for ModbusTcpRead {
    fn fmt(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        formatter
            .debug_struct("ModbusTcpRead")
...
//
// 
impl Service for ModbusTcpRead {
    //
    // 
