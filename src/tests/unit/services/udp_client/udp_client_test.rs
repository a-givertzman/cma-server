...
mod tests {
    ...
    use testing::stuff::{max_test_duration::TestDuration, random_test_values::RandomTestValues, wait::WaitTread};
    ...
    fn test_task_cycle() {
        ...
        let udp_server = Arc::new(RwLock::new(MockUdpServer::new(
            self_id,
            MockUdpServerConfig { name: Name::new(self_id, "MockUdpServer"), local_addr: "127.0.0.1:15180".to_owned(), channel: 0 },
            services.clone(),
            &test_data,
        )));
