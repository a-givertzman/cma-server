            ...
            serde_yaml::from_str(r"
                ...
                blocks:
                    ...
                    - '5':
                        ...
                        bind: Boom 1                # Привязка блока к стреле (нумерация с 0), Fixed - Барабан, Boom 0 - Блок на первой стреле, Hook - Блок на подвесе
                        deflector-angle: 28.4 deg   # Блок включается в работу только когда стрела проходит положение перекидывания. Угол от горизонтали.
                    - '6':
            ...
            CraneConf {
                ...
                blocks: vec![
                    ...
                    ("5".to_owned(), BlockConf {
                        ...
                        d: ConfDistance::new(816.0, ConfDistanceUnit::Millimeter),
                        scheme: BlockScheme::bottom_top(),
                        bind: BlockBind::Boom(1),
                        deflector: Some(ConfAngle::new(28.4, ConfAngleUnit::Degrees)),
                    }),
