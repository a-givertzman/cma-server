...
use plotters::{
    ...
    coord::types::RangedCoordf64, prelude::{BitMapBackend, Cartesian2d, Circle, EmptyElement, IntoDrawingArea},
...
///
/// 
/// ### Plot the cart with series of x, y
/// 
/// Writes a chart into the `path`
/// 
/// - `path` - target file name with extension 
/// - `size` - target file dimensions (width, height)
/// - `series` - array of lines, each of line represented by vector of (x, y)
/// - `kind` - variant of representation
