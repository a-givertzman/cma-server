...
mod cma_recorder {
    ...
    fn operating_metric() {
        ...
        //  step    nape                                input                    Pp Cycle   target_thrh             target_smooth
            ...
            ("64.0",    format!("/{}/Load", dbg),       Value::Real(  0.00),       0,       00.0000,                0.0),
            ("65.0",    format!("/{}/Load", dbg),       Value::Real(  3.30),       0,       00.0000,                0.4125),
            ("66.0",    format!("/{}/Load", dbg),       Value::Real(  0.10),       0,       00.0000,                0.3734375),
            ("67.0",    format!("/{}/Load", dbg),       Value::Real(  0.00),       0,       00.0000,                0.3267578125),
            ("68.0",    format!("/{}/Load", dbg),       Value::Real(  1.60),       0,       00.0000,                0.4859130859375),
            ("69.0",    format!("/{}/Load", dbg),       Value::Real(  0.00),       0,       00.0000,                0.425173950195313),
            ("70.0",    format!("/{}/Load", dbg),       Value::Real(  7.20),       0,       00.0000,                1.2720272064209),
            ("71.0",    format!("/{}/Load", dbg),       Value::Real(  0.00),       0,       00.0000,                1.11302380561829),
            ("72.0",    format!("/{}/Load", dbg),       Value::Real(  0.30),       0,       00.0000,                1.011395829916),
            ("73.0",    format!("/{}/Load", dbg),       Value::Real(  2.20),       0,       00.0000,                1.1599713511765),
            ("74.0",    format!("/{}/Load", dbg),       Value::Real(  8.10),       0,       00.0000,                2.02747493227944),
            ("75.0",    format!("/{}/Load", dbg),       Value::Real(  1.90),       0,       00.0000,                2.01154056574451),
            ("76.0",    format!("/{}/Load", dbg),       Value::Real(  0.10),       0,       00.0000,                1.77259799502644),
            ("77.0",    format!("/{}/Load", dbg),       Value::Real(  0.00),       0,       00.0000,                1.55102324564814),
            ("78.0",    format!("/{}/Load", dbg),       Value::Real(  0.00),       0,       00.0000,                1.35714533994212),
            ("79.0",    format!("/{}/Load", dbg),       Value::Real(  5.00),       0,       00.0000,                1.81250217244936),
            ("80.0",    format!("/{}/Load", dbg),       Value::Real(  2.00),       0,       00.0000,                1.83593940089319),
            ("81.1",    format!("/{}/Winch1.Load.Limiter.Trip", dbg),       Value::Bool(true),       0,       00.0000,                1.83593940089319),
            ("82.2",    format!("/{}/Winch1.Load.Limiter.Trip", dbg),       Value::Bool(false),       0,       00.0000,                1.83593940089319),
            ("83.3",    format!("/{}/Winch2.Load.Limiter.Trip", dbg),       Value::Bool(true),       0,       00.0000,                1.83593940089319),
            ("84.4",    format!("/{}/Winch2.Load.Limiter.Trip", dbg),       Value::Bool(false),       0,       00.0000,                1.83593940089319),
            ("85.5",    format!("/{}/Winch3.Load.Limiter.Trip", dbg),       Value::Bool(true),       0,       00.0000,                1.83593940089319),
            ("86.6",    format!("/{}/Winch3.Load.Limiter.Trip", dbg),       Value::Bool(false),       0,       00.0000,                1.83593940089319),
            ("87.0",    format!("/{}/Load", dbg),       Value::Real(  1.00),       0,       00.0000,                1.73144697578154),
            ("88.0",    format!("/{}/Load", dbg),       Value::Real(  0.00),       0,       00.0000,                1.51501610380885),
            ("89.0",    format!("/{}/Load", dbg),       Value::Real(  2.00),       0,       00.0000,                1.57563909083274),
            ("90.0",    format!("/{}/Load", dbg),       Value::Real(  4.00),       0,       00.0000,                1.87868420447865),
            ("91.0",    format!("/{}/Load", dbg),       Value::Real(  6.00),       0,       00.0000,                2.39384867891882),
            ("92.0",    format!("/{}/Load", dbg),       Value::Real( 12.00),       0,       00.0000,                3.59461759405396),
            ("93.0",    format!("/{}/Load", dbg),       Value::Real( 64.00),       1,       11.1452903947972,       11.1452903947972),
            ("94.0",    format!("/{}/Load", dbg),       Value::Real(128.00),       1,       25.7521290954476,       25.7521290954476),
            ("95.0",    format!("/{}/Load", dbg),       Value::Real(120.00),       1,       37.5331129585166,       37.5331129585166),
            ("96.0",    format!("/{}/Load", dbg),       Value::Real(133.00),       1,       49.466473838702,       49.466473838702),
            ("97.0",    format!("/{}/Load", dbg),       Value::Real(121.00),       1,       58.4081646088643,       58.4081646088643),
            ("98.0",    format!("/{}/Load", dbg),       Value::Real(130.00),       1,       67.3571440327563,       67.3571440327563),
            ("99.0",    format!("/{}/Load", dbg),       Value::Real(127.00),       1,       67.3571440327563,       74.8125010286617),
            ("100.0",    format!("/{}/Load", dbg),       Value::Real(123.00),       1,       80.835938400079,       80.835938400079),
            ("101.0",    format!("/{}/Load", dbg),       Value::Real(122.00),       1,       80.835938400079,       85.9814461000691),
            ("102.0",    format!("/{}/Load", dbg),       Value::Real(120.00),       1,       90.2337653375605,       90.2337653375605),
            ("103.0",    format!("/{}/Load", dbg),       Value::Real( 64.00),       1,       90.2337653375605,       86.9545446703654),
            ("104.0",    format!("/{}/Load", dbg),       Value::Real( 32.00),       1,       80.0852265865698,       80.0852265865698),
            ("105.0",    format!("/{}/Load", dbg),       Value::Real( 24.00),       1,       80.0852265865698,       73.0745732632485),
            ("106.0",    format!("/{}/Load", dbg),       Value::Real( 12.00),       1,       65.4402516053425,       65.4402516053425),
            ("107.0",    format!("/{}/Load", dbg),       Value::Real(  8.00),       1,       65.4402516053425,       58.2602201546747),
            ("108.0",    format!("/{}/Load", dbg),       Value::Real( 17.00),       1,       53.1026926353403,       53.1026926353403),
            ("109.0",    format!("/{}/Load", dbg),       Value::Real( 10.00),       1,       53.1026926353403,       47.7148560559228),
            ("110.0",    format!("/{}/Load", dbg),       Value::Real(  7.00),       1,       42.6254990489324,       42.6254990489324),
            ("111.0",    format!("/{}/Load", dbg),       Value::Real(  3.00),       1,       42.6254990489324,       37.6723116678159),
            ("112.0",    format!("/{}/Load", dbg),       Value::Real(  6.00),       1,       33.7132727093389,       33.7132727093389),
            ("113.0",    format!("/{}/Load", dbg),       Value::Real(  4.00),       1,       33.7132727093389,       29.9991136206715),
            ("114.0",    format!("/{}/Load", dbg),       Value::Real(  2.00),       1,       33.7132727093389,       26.4992244180876),
            ("115.0",    format!("/{}/Load", dbg),       Value::Real(  0.00),       1,       23.1868213658266,       23.1868213658266),
            ("116.0",    format!("/{}/Load", dbg),       Value::Real(  4.00),       1,       23.1868213658266,       20.7884686950983),
            ("117.1",    format!("/{}/Winch1.Load.Limiter.Trip", dbg),       Value::Bool(true),       1,       23.1868213658266,       20.7884686950983),
            ("118.0",    format!("/{}/Load", dbg),       Value::Real(  2.00),       1,       23.1868213658266,       18.439910108211),
            ("119.0",    format!("/{}/Load", dbg),       Value::Real(  1.00),       1,       23.1868213658266,       16.2599213446847),
            ("120.0",    format!("/{}/Load", dbg),       Value::Real(  3.00),       1,       14.6024311765991,       14.6024311765991),
            ("121.0",    format!("/{}/Load", dbg),       Value::Real(  0.00),       1,       14.6024311765991,       12.7771272795242),
            ("122.0",    format!("/{}/Load", dbg),       Value::Real(  2.00),       1,       14.6024311765991,       11.4299863695837),
            ("123.0",    format!("/{}/Load", dbg),       Value::Real(  1.00),       1,       14.6024311765991,       10.1262380733857),
            ("124.0",    format!("/{}/Load", dbg),       Value::Real(  0.70),       1,       14.6024311765991,       8.94795831421249),
            ("125.0",    format!("/{}/Load", dbg),       Value::Real(  0.80),       1,       14.6024311765991,       7.92946352493593),
            ("126.0",    format!("/{}/Load", dbg),       Value::Real(  0.40),       0,       6.98828058431894,       6.98828058431894),
            ("127.0",    format!("/{}/Load", dbg),       Value::Real(  0.30),       0,       6.98828058431894,       6.15224551127907),
            ("128.0",    format!("/{}/Exit", dbg),       Value::String("exit".to_owned()),       0,       6.98828058431894,       2.78124897825802),
        ...
        let received: Vec<String> = receiver.received()
            .into_iter()
        ...
        let op_cycle_is_active: Vec<Point> = receiver.received().into_iter().filter(|point| {
        ...
        let op_cycle_sql: Vec<Point> = receiver.received().into_iter().filter(|point| {
