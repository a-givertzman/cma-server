...
mod udp_client_config {
    ...
    use sal_sync::{collections::FxIndexMap, services::{conf::DiagKeywd, entity::{Name, {PointConfig, PointConfigHistory, PointConfigType}}, LinkName, subscription::ConfSubscribe}};
